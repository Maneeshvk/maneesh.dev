const INFO = {
  ...
  homepage: {
    ...
    description:
      "I am a dedicated and experienced full stack developer with a passion for creating innovative web and mobile solutions. With 3 years of hands-on experience, I have mastered a wide range of technologies, including JavaScript, React, React Native, Flutter, Python, and AWS. My expertise extends beyond coding; I have successfully managed and led teams, overseeing projects with a team size of 5, ensuring efficient collaboration and exceptional results.",
  },
  ...
  projects: [
    ...
    {
      title: "Film Management Tool",
      description:
        "This tool is crafted to assist professionals in the film industry with their daily tasks, including scheduling calendars, managing video uploads, and organizing meetings. Developed with React, the platform offers seamless user interactions and integrates Tailwind CSS for a sleek design. The application's database, powered by MySQL, is securely hosted on AWS.",
      logo: "https://cdn.jsdelivr.net/npm/programming-languages-logos/src/javascript/javascript.png",
      //   linkText: "View Project",
      //   link: "https://github.com",
    },
